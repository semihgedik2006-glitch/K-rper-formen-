...
| | | Quelle |
|---|---|---|
| Anwendung | `index.html`, **33.377 Zeilen** | `wc -l` |
| Serverfunktionen | **62** Cloud Functions | `grep -c '^exports\.'` |
| Sicherheitsregeln | `firestore.rules`, **2.170 Zeilen** | `wc -l` |
| Automatische Durchläufe (Oberfläche) | **134** (131 `test-*`, dazu zwei Prüfungen und ein Belastungstest) | `ls tests/*.js` ohne `stub-` |
