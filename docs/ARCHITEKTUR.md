...
| Komponentendateien | 32.231 Zeilen in **einer** Datei (Stand 24.9.2026) |
...
│  BROWSER                                                     │
│                                                              │
│   index.html   ── die ganze Anwendung (32.231 Zeilen)        │
...
| | Wofür |
|---|---|
| `playwright` + Chromium | 126 Durchläufe über die echte Oberfläche |
...
| | Warum |
|---|---|
| 32.231 Zeilen in einer Datei | bewusst so; der Preis ist Auffindbarkeit |
