...
| Komponentendateien | 33.900 Zeilen in **einer** Datei (Stand 24.9.2026) |
...
│  BROWSER                                                     │
│                                                              │
│   index.html   ── die ganze Anwendung (33.900 Zeilen)        │
...
| | Wofür |
|---|---|
| `playwright` + Chromium | 139 Durchläufe über die echte Oberfläche |
...
| | Warum |
|---|---|
| 33.900 Zeilen in einer Datei | bewusst so; der Preis ist Auffindbarkeit |
