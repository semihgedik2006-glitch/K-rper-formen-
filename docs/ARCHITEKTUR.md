...
| Komponentendateien | 33.129 Zeilen in **einer** Datei (Stand 24.9.2026) |
...
│  BROWSER                                                     │
│                                                              │
│   index.html   ── die ganze Anwendung (33.129 Zeilen)        │
...
| | Wofür |
|---|---|
| `playwright` + Chromium | 131 Durchläufe über die echte Oberfläche |
...
| | Warum |
|---|---|
| 33.129 Zeilen in einer Datei | bewusst so; der Preis ist Auffindbarkeit |
