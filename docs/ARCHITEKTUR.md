...
| Komponentendateien | 31.777 Zeilen in **einer** Datei (Stand 23.9.2026) |
...
│  BROWSER                                                     │
│                                                              │
│   index.html   ── die ganze Anwendung (31.777 Zeilen)        │
...
| | Wofür |
|---|---|
| `playwright` + Chromium | 125 Durchläufe über die echte Oberfläche |
...
| | Warum |
|---|---|
| 31.777 Zeilen in einer Datei | bewusst so; der Preis ist Auffindbarkeit |
