...
| Komponentendateien | 26.814 Zeilen in **einer** Datei |
...
│  BROWSER                                                     │
│                                                              │
│   index.html   ── die ganze Anwendung (26.814 Zeilen)        │
...
| | Wofür |
|---|---|
| `playwright` + Chromium | 113 Durchläufe über die echte Oberfläche |
...
| | Warum |
|---|---|
| 26.814 Zeilen in einer Datei | bewusst so; der Preis ist Auffindbarkeit |
