...
| Komponentendateien | 33.400 Zeilen in **einer** Datei (Stand 24.9.2026) |
...
│  BROWSER                                                     │
│                                                              │
│   index.html   ── die ganze Anwendung (33.400 Zeilen)        │
...
| | Wofür |
|---|---|
| `playwright` + Chromium | 135 Durchläufe über die echte Oberfläche |
...
| | Warum |
|---|---|
| 33.400 Zeilen in einer Datei | bewusst so; der Preis ist Auffindbarkeit |
